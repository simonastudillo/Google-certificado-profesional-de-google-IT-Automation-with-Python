...
## ¿Qué es Python?
- Utilizaremos el lenguaje de programación Python para demostrar los ​conceptos básicos de programación y cómo aplicarlos a la escritura de scripts.
- ¿Por qué elegir Python?
  - Es similar al lenguaje humano, haciendo facil la lectura y escritura de código.
